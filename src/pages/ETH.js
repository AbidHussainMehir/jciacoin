...
import { Footer, Header, Nav, TabPanes, Tokens, UnlockWallet, Wallets } from '../components'
									...
									<div className="pools">
										...
										<div className="tab-content">
											<div className="container py_0 tab-pane active">
			                                    ...
			                                    <div className="exchange_hd">
			                                        <ul className="nav nav-pills pool_tab" role="tablist">
								                        ...
								                        <li className="nav-item">
								                            <a className="nav-link active" href="liquidity">Liquidity</a>
								                        </li>
								                    </ul>
			                                    </div>
			                                ...
			                                <div className="exchange_wrap">
			                                    <div className="exchange_hd">
			                                          <h2 style={{"color":"#016eda"}}><i className="fa fa-arrow-left"></i> <span style={{"padding-left":"30px"}}>Add Liquidity</span></h2>
			                                    </div>
			                                    <div className="exchange_tools">
			                                        <div className="tools_img pyx_5">
															...
															<div className="exchange_tools">
																<div className="bnb_btn bnb_position">
																	...
																	<button className="min_wth" onClick={() => window.openNav8()}>
																		...
																		<span className="selct_tkn">Select Currency</span>
																	</button>
																</div>
															</div>
